...
```javascript
import ndarraylike2ndarray from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-ndarraylike2ndarray@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-ndarraylike2ndarray/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/ndarray-ndarraylike2ndarray/actions/workflows/test.yml?query=branch:v0.1.0
