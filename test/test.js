...
tape( 'the function throws an error if provided a `readonly` option equal to `true` when the first argument is a read-only ndarray', function test( t ) {
	var xbuf;
	var x;
...
tape( 'by default, the function returns a read-only ndarray if provided a read-only ndarray (ndarray)', function test( t ) {
	var expected;
	var actual;
	var xbuf;
	var x;
...
tape( 'the function supports ndarray options (ndarray)', function test( t ) {
	var expected;
	var actual;
	var xbuf;
	var x;
...
tape( 'the function supports ndarray options (ndarray-like)', function test( t ) {
	var expected;
	var actual;
	var xbuf;
	var x;
